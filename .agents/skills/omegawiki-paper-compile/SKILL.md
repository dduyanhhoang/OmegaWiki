...
# $omegawiki-paper-compile

> Compile a LaTeX paper to PDF, auto-fix common errors, and verify submission requirements.
> Input: the paper/ directory generated by $omegawiki-paper-draft. Run latexmk compilation,
...
- `.agents/skills/shared-references/citation-verification.md` — [UNCONFIRMED] marker check rules
...
- Run `$omegawiki-refine paper/main.tex --focus writing` for final polish
...
- **main.tex not found**: error; suggest running $omegawiki-paper-draft first
...
### Shared References
- `.agents/skills/shared-references/citation-verification.md` — [UNCONFIRMED] marker check rules
- `.agents/skills/shared-references/academic-writing.md` — venue page limit reference

### Called by
- `$omegawiki-research` Stage 5 (paper compilation stage)
