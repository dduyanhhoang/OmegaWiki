...
> Shared reference for all skills that generate citations: $omegawiki-paper-draft, $omegawiki-survey, $omegawiki-paper-plan.
...
4. The `[UNCONFIRMED]` marker is a **hard blocker** for submission — $omegawiki-paper-compile must flag all remaining `[UNCONFIRMED]` entries
