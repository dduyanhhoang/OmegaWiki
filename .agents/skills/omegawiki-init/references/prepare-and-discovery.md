# $omegawiki-init Prepare And Discovery

Use this reference when `$omegawiki-init` is preparing local inputs, selecting the final paper set, or writing `.checkpoints/init-sources.json`.
