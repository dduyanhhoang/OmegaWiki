...
> Draft a complete LaTeX paper from the PAPER_PLAN.md generated by $omegawiki-paper-plan.
...
- `.agents/skills/shared-references/academic-writing.md` — writing standards
...
4. Print to terminal:
   ...
   - [UNCONFIRMED] citations: {count} (resolve before $omegawiki-paper-compile)

   ## Next Steps
   - Run `$omegawiki-paper-compile paper/` to compile and verify
   - Resolve [UNCONFIRMED] citations manually
   - Run `$omegawiki-refine paper/main.tex --focus writing` for further polish
   ```
...
- **PAPER_PLAN not found**: error; suggest running $omegawiki-paper-plan first
- **PAPER_PLAN format incomplete**: list missing sections; suggest re-running $omegawiki-paper-plan
...
### Shared References
- `.agents/skills/shared-references/academic-writing.md` — writing standards + de-AI polish rules + figure design
- `.agents/skills/shared-references/citation-verification.md` — BibTeX fetch workflow + [UNCONFIRMED] protocol
