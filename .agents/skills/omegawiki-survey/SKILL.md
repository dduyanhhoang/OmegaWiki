...
- `.agents/skills/shared-references/academic-writing.md` — Related Work writing rules
...
5. **If candidate papers < 5**: warn "insufficient related papers; consider $omegawiki-ingest of more papers first"
...
- **Warn when candidate papers < 5**: prompt user to $omegawiki-ingest more papers first
...
- **Fewer than 3 wiki papers**: error; suggest $omegawiki-ingest of enough papers first
...
### MCP Servers
- None (survey does not require Review LLM; use $omegawiki-review --focus writing for separate review)
...
### Shared References
- `.agents/skills/shared-references/academic-writing.md` — Related Work writing rules + de-AI polish
- `.agents/skills/shared-references/citation-verification.md` — BibTeX fetch and [UNCONFIRMED] protocol

### Called by
- `$omegawiki-paper-draft` Step 3 (Related Work section can be delegated to this skill)
