...
- **wiki is empty**: inform the user to first run `$omegawiki-init` or `$omegawiki-ingest` to build the knowledge base
...
- `$omegawiki-ingest` — referenced when suggesting the user supplement knowledge

### Shared References
- `.agents/skills/shared-references/citation-verification.md` (created in Phase 3)
