...
4. **Edge confidence**: `$omegawiki-ingest` paper-paper and paper-concept semantic edges use `confidence: high|medium|low`
...
- **wiki/ does not exist**: report error and suggest running `$omegawiki-init`
